...
export function HighlightRulesTable(props: Props): ReactElement {
  ...
  return <div className="highlight-rules-table-wrap"><table className="highlight-rules-table">
    <thead><tr><th>{t('highlightRules.columns.pattern')}</th><th className="hl-option-cell">{t('highlightRules.columns.on')}</th><th className="hl-option-cell">{t('highlightRules.columns.sound')}</th><th className="hl-color-cell">{t('highlightRules.columns.color')}</th><th className="hl-row-actions" /></tr></thead>
    <tbody>
